node('linuxslave') {
   ...
   env.APP_VERSION = VersionNumber([
    ...
    stage('Multiple SCM checkout ') {
        ...
        build job: 'RootPipelineTemplate', parameters: [string(name: 'BUILDSCRIPTS_REPO_URL', value: 'https://github.com/rajeshhereforyou/JenkinsPipelineProject.git'), string(name: 'BUILDSCRIPTS_REPO_BRANCH', value: '*/master'), string(name: 'BUILDSCRIPTS_DIR', value: '${BUILDSCRIPTS_DIR}'), string(name: 'MAJOR_MINOR_VERSION', value: '1.0'), booleanParam(name: 'executePrintTask', value: false)]
