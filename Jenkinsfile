    ...
    stages {
        ...
        stage('Multiple SCM checkout ') {
            steps {
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/sonarqube_changes']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/rajeshhereforyou/myspringbootapp.git']]])
